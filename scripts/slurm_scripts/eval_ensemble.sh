...
#   自动扫描 checkpoints/ensemble_focal 目录下的所有 seed checkpoint
#   
# 使用方法:
...
# 列出将要评估的 checkpoint
echo "扫描 checkpoints/ensemble_focal 目录..."
find checkpoints/ensemble_focal -name "hat_cls_best.pt" 2>/dev/null
echo ""
