...
# ============================================================================
# 多 Seed Ensemble 训练脚本 - Focal Loss 版本 (SLURM Array Job)
# 
# 说明:
#   使用 Focal Loss 进行多 seed ensemble 训练
#   Focal Loss 能更好地处理难样本和类别不平衡问题
#   
# 使用方法:
#   sbatch scripts/slurm_scripts/train_ensemble_focal.sh
# ============================================================================
...
echo "=============================================="
echo "SLURM Array Job: Focal Loss Training with seed=$SEED"
...
echo "=== 开始 Focal Loss Ensemble 训练 (Seed=$SEED) ==="
echo "工作目录: $(pwd)"
echo ""
